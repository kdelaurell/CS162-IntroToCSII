...
Bench::Bench(string name, string itemName, string monsterName){
  this->cR1 = NULL;
  this->cR2 = NULL;
  this->cR3 = NULL;
  this->cR4 = NULL;
...
void Bench::DisplayItemOptions(){
  cout << "Option 8: Pick up " << this->roomItem << endl;
}

void Bench::setConnectedRooms(Spaces* room1, Spaces* room2, Spaces* room3, Spaces* room4, Spaces* room5, Spaces* room6, Spaces* room7){
  this->cR1 = room1;
  this->cR2 = room2;
  this->cR3 = room3;
  this->cR4 = room4;
...
int Bench::getNumConnectedRooms(){
  int count = 0;
  if(this->cR1 != NULL)
    count++;
  if(this->cR2 != NULL)
...
string Bench::getName(){
  return this->roomName;
}

string Bench::getRoomItem(){
  string temp;
  temp = this->roomItem;
  this->roomItem = "";
  return temp;
...
void Bench::addItem(string newOldItem){
  this->roomItem = newOldItem;
}

Spaces* Bench::getNewLocation(int choice){
  if(choice == 1){
    return this->cR1;
  }
  else if(choice == 2){
...
int Bench::monsterAttack(string usedItem){
    return 0;
}
...
int Bench::intiateSpecial(){
  cout << "You are sitting there collecting dust like the good bench warmer you are! Congrats!" << endl;
  return 2;
}
